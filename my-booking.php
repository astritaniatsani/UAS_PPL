...
<?php 
$useremail=$_SESSION['login'];
 $sql = "SELECT tbllapang.vimage1 as vimage1,tbllapang.namalapang,tbllapang.id as vid,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.Status  from tblbooking join tbllapang on tblbooking.LapangId=tbllapang.id  where tblbooking.userEmail=:useremail";
$query = $dbh -> prepare($sql);
$query-> bindParam(':useremail', $useremail, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
<li>
                ...
                <div class="vehicle_title">
                  <h6><a href="vehical-details.php?vhid=<?php echo htmlentities($result->vid);?>"">  <?php echo htmlentities($result->namalapang);?></a></h6>

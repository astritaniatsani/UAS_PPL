...
$sql = "SELECT id from tbllapang where tbllapang.tipelapang=:tipelapang";
...
<?php 
$tipelapang=$_POST['tipelapang'];
$sql = "SELECT * from tbllapang where tipelapang=:tipelapang";
$query = $dbh -> prepare($sql);
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"> <?php echo htmlentities($result->namalapang);?></a></h5>
            <p class="list-price">Rp <?php echo htmlentities($result->harga);?> Per Jam</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->lokasi);?></li>
             
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->tipelapang);?></li>
            </ul>
          ...
          <div class="sidebar_filter">
            <form action="search-carresult.php" method="post">
              <div class="form-group select">
                <select class="form-control" name="tipelapang">
                  <option>Select Tipe Lapangan</option>
...
<option value="Voli">Voli</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Cari Lapang</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <!--div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul-->
<!--?php $sql = "SELECT tbllapang.*,tblbrands.BrandName,tblbrands.id as bid  from tbllapang join tblbrands on tblbrands.id=tbllapang.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
